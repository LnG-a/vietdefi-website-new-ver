  ...
  return (
    <div className="artist_container">
      <div className="artist_content">
        ...
        <h2>{t(messages.Development_roadmapTitle())}</h2>
        <ul>
          <li>{t(messages.Development_roadmapLine1())}</li>
          <li>{t(messages.Development_roadmapLine2())}</li>
          <li>{t(messages.Development_roadmapLine3())}</li>
          <li>{t(messages.Development_roadmapLine4())}</li>
          <li>{t(messages.Development_roadmapLine5())}</li>
        </ul>
        ...
        <ul>
          ...
          <li>{t(messages.applyLine_4())}</li>
          <li>{t(messages.applyLine_5())}</li>
          <li>{t(messages.applyLine_6())}</li>
          <li>{t(messages.applyLine_7())}</li>
          <li>{t(messages.applyLine_8())}</li>
        </ul>
